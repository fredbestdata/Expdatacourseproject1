...
plot(dataset$timestamp, dataset$Sub_metering_1, type="l", col=columnlines[1], xlab="", ylab="Energy sub metering")
lines(dataset$timestamp, dataset$Sub_metering_2, col=columnlines[2])
lines(dataset$timestamp, dataset$Sub_metering_3, col=columnlines[3])
